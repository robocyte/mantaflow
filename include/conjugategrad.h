...
{
    ApplyMatrix(FlagGrid& flags, Grid<Real>& dst, Grid<Real>& src, Grid<Real>& A0, Grid<Real>& Ai, Grid<Real>& Aj, Grid<Real>& Ak) : KernelBase(&flags,0)
        , flags(flags)
        , dst(dst)
        , src(src)
        , A0(A0)
    ...
    inline void op(int idx, FlagGrid& flags, Grid<Real>& dst, Grid<Real>& src, Grid<Real>& A0, Grid<Real>& Ai, Grid<Real>& Aj, Grid<Real>& Ak)
    {
...
#pragma omp for
            for (int i=0; i < _sz; i++)
                op(i,flags,dst,src,A0,Ai,Aj,Ak);
        }
    }
...
{
    ApplyMatrix2D(FlagGrid& flags, Grid<Real>& dst, Grid<Real>& src, Grid<Real>& A0, Grid<Real>& Ai, Grid<Real>& Aj, Grid<Real>& Ak)
        : KernelBase(&flags,0)
        , flags(flags)
        , dst(dst)
        , src(src)
...
{
    MakeLaplaceMatrix(FlagGrid& flags, Grid<Real>& A0, Grid<Real>& Ai, Grid<Real>& Aj, Grid<Real>& Ak, MACGrid* fractions = 0)
        : KernelBase(&flags,1)
        , flags(flags)
        , A0(A0)
        , Ai(Ai)
    ...
    inline void op(int i, int j, int k, FlagGrid& flags, Grid<Real>& A0, Grid<Real>& Ai, Grid<Real>& Aj, Grid<Real>& Ak, MACGrid* fractions = 0)
    {
