...
template<class T>
inline Vector3D<double> toVec3d(T v)
{
...
template<class T>
inline Vector3D<float> toVec3f(T v)
{
...
/**************************************************************************/
template<>
inline Vec3 clamp<Vec3>(const Vec3& a, const Vec3& b, const Vec3& c)
{
...
template<>
inline Vec3 safeDivide<Vec3>(const Vec3 &a, const Vec3& b)
{ 
	return Vec3(safeDivide(a.x,b.x), safeDivide(a.y,b.y), safeDivide(a.z,b.z));
}

template<>
inline Vec3 nmod<Vec3>(const Vec3& a, const Vec3& b)
{
