...
void Shape::applyToMACGrid(MACGrid* grid, Vec3 value, FlagGrid* respectFlags)
{
    ApplyShapeToMACGrid(grid, this, value, respectFlags);
}
...
struct BoxSDF : public KernelBase
{
    ...
    inline Grid<Real>& getArg0() { return phi; }
    typedef Grid<Real> type0;
    inline const Vec3& getArg1() { return p1; }
    typedef Vec3 type1;
    inline const Vec3& getArg2() { return p2; }
    typedef Vec3 type2;
...
struct SphereSDF : public KernelBase
{
    ...
    inline Grid<Real>& getArg0() { return phi; }
    typedef Grid<Real> type0;
    inline Vec3& getArg1() { return center; }
    typedef Vec3 type1;
    inline Real& getArg2() { return radius; }
    typedef Real type2;
    inline Vec3& getArg3() { return scale; }
    typedef Vec3 type3;
...
struct CylinderSDF : public KernelBase
{
    ...
    inline Real& getArg2() { return radius; }
    typedef Real type2;
    inline Vec3& getArg3() { return zaxis; }
    typedef Vec3 type3;
    inline Real& getArg4() { return maxz; }
    typedef Real type4;
...
struct SlopeSDF : public KernelBase
{
    ...
    inline const Vec3& getArg0() { return n; }
    typedef Vec3 type0;
    inline Grid<Real> & getArg1() { return phiObs; }
    typedef Grid<Real> type1;
    inline const Real& getArg2() { return fac; }
    typedef Real type2;
    inline const Real& getArg3() { return origin; }
    typedef Real type3;
