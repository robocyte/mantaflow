...
int main()
{
    ...
    while (t < 999)
    {
        ...
        particle_filename << "simulation data\\flip02_surface\\flipParts_" << std::setw(4) << std::setfill('0') << t << ".uni";
        ...
        mesh_filename << "simulation data\\flip03_generated\\fluidsurface_final_" << std::setw(4) << std::setfill('0') << t << ".bobj.gz";
