...
//*****************************************************************************
template<class T>
void writeGridTxt(const std::string& name, Grid<T>* grid)
{
...
template<class T>
void writeGridRaw(const std::string& name, Grid<T>* grid)
{
...
template<class T>
void readGridRaw(const std::string& name, Grid<T>* grid)
{
...
#	endif
	debMsg("File '"<<name<<"', no valid info std::string found",1);
}

//! for auto-init & check of results of test runs
void getUniFileSize(const std::string& name, int& x, int& y, int& z, int* t)
{
	x = y = z = 0;
#	if NO_ZLIB!=1
	gzFile gzf = gzopen(name.c_str(), "rb");
...
Vec3 getUniFileSize(const std::string& name)
{
	int x,y,z;
...
template <class T>
void writeGridUni(const std::string& name, Grid<T>* grid)
{
...
template <class T>
void readGridUni(const std::string& name, Grid<T>* grid)
{
...
template <class T>
void writeGridVol(const std::string& name, Grid<T>* grid)
{
...
template <>
void writeGridVol<Real>(const std::string& name, Grid<Real>* grid)
{
...
template <class T>
void readGridVol(const std::string& name, Grid<T>* grid)
{
	debMsg( "writing grid " << grid->getName() << " to vol file " << name ,1);
	errMsg("Type not yet supported!");
}
...
template <>
void readGridVol<Real>(const std::string& name, Grid<Real>* grid)
{
...
template void writeGridRaw<int> (const std::string& name, Grid<int>*  grid);
template void writeGridRaw<Real>(const std::string& name, Grid<Real>* grid);
template void writeGridRaw<Vec3>(const std::string& name, Grid<Vec3>* grid);
template void writeGridUni<int> (const std::string& name, Grid<int>*  grid);
template void writeGridUni<Real>(const std::string& name, Grid<Real>* grid);
template void writeGridUni<Vec3>(const std::string& name, Grid<Vec3>* grid);
template void writeGridVol<int> (const std::string& name, Grid<int>*  grid);
template void writeGridVol<Vec3>(const std::string& name, Grid<Vec3>* grid);
template void readGridVol<int> (const std::string& name, Grid<int>*  grid);
template void readGridVol<Vec3>(const std::string& name, Grid<Vec3>* grid);
template void writeGridTxt<int> (const std::string& name, Grid<int>*  grid);
template void writeGridTxt<Real>(const std::string& name, Grid<Real>* grid);
template void writeGridTxt<Vec3>(const std::string& name, Grid<Vec3>* grid);
template void readGridRaw<int>  (const std::string& name, Grid<int>*  grid);
template void readGridRaw<Real> (const std::string& name, Grid<Real>* grid);
template void readGridRaw<Vec3> (const std::string& name, Grid<Vec3>* grid);
template void readGridUni<int>  (const std::string& name, Grid<int>*  grid);
template void readGridUni<Real> (const std::string& name, Grid<Real>* grid);
template void readGridUni<Vec3> (const std::string& name, Grid<Vec3>* grid);
